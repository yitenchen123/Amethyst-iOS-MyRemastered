...
public abstract class Callback implements Pointer, NativeResource {
    ...
    /** Returns the address of the native callback handler for the specified method. [iOS: dispatched through Callback so the 3.3.x-era dylib symbol is used] */
    static native long getCallbackHandler(Method callback);
