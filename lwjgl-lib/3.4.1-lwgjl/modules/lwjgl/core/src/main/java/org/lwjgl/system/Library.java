...
public final class Library {
    ...
    static {
        ...
        try {
            // pojavexec is used to bridge GLFW with Android and loading vulkan driver for Android.
            // NOTE: On iOS the app binary (AngelAuraAmethyst) is NOT loaded here. Loading it from
            // Library.<clinit> triggers JNI_OnLoad -> JNI_OnLoadGLFW before org.lwjgl.glfw.GLFW is
            // even loaded, which makes FindClass/GetStaticMethodID fail and the JVM crashes.
            // The app binary is loaded by GLFW.<clinit> (after keyDownBuffer is assigned), which is
            // the proven working flow.
